...
public class FruitQuiz extends KeyAdapter {
	...
	void makeQuestions() {
		...
		question2 = new JLabel("<html>What would most do? <br> A: buy a race car <br> B: be the most popular <br> C: have a rich wife or husband</html>");
	}
